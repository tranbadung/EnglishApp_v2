      ...
      children: imagePaths.map((imagePath) {
        return Padding(
          padding: const EdgeInsets.only(
              bottom: 8.0), // Add some spacing between images
          child: Image.asset(
            imagePath,
            width: width,
            height: height,
            ...
            errorBuilder: (context, error, stackTrace) {
              return Container(
                color: Colors
                    .grey, // Background color when the image fails to load
                child: Center(child: Text('Image not found')), // Error message
              );
            },
          ),
        );
